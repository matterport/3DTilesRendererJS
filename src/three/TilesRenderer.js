...
import { CustomTileLoader } from './CustomTileLoader.js';
...
export class TilesRenderer extends TilesRendererBase {
	...
	constructor( ...args ) {
		...
		this.registerTileContentParser( 'gltf', CustomTileLoader );
		this.registerTileContentParser( 'glb', CustomTileLoader );
